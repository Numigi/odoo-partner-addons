...
class TestResPartner(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        partner_phone_field_id = cls.env.ref(
            'base.field_res_partner__phone').id
        phone_vals = {
        ...
        partner_email_field_id = cls.env.ref(
            'base.field_res_partner__email').id
        email_vals = {
    ...
    def test_01_confirm_customer_with_normal_user(self):
        self.partner.with_user(self.normal_user).confirm_customer()
    ...
    def test_02_approve_customer_with_normal_user(self):
        ...
        with self.assertRaises(WarningOdoo):
            self.partner.with_user(self.normal_user).approve_customer()

    def test_03_reject_customer_with_normal_user(self):
        self.partner.with_user(self.customer_approval_user).approve_customer()
        self.assertEqual(self.partner.customer_state, 'approved')
        self.partner.with_user(self.normal_user).reject_customer()
        self.assertEqual(self.partner.customer_state, 'new')

    def test_04_confirm_customer_with_approval_user(self):
        self.partner.with_user(self.customer_approval_user).confirm_customer()
        self.assertEqual(self.partner.customer_state, 'confirmed')
    ...
    def test_06_reject_customer_with_approval_user(self):
        self.partner.with_user(self.customer_approval_user).approve_customer()
        self.assertEqual(self.partner.customer_state, 'approved')
        self.partner.with_user(self.customer_approval_user).reject_customer()
        self.assertEqual(self.partner.customer_state, 'new')
    ...
    def test_07_write_rescricted_field_with_normal_user(self):
        ...
        self.assertEqual(self.partner.customer_state, 'approved')
        with self.assertRaises(WarningOdoo):
            self.partner.with_user(self.normal_user).write({
                'phone': '555-666-777',
            })
    ...
    def test_09_write_rescricted_field_with_approval_user(self):
        self.partner.with_user(self.customer_approval_user).approve_customer()
        self.assertEqual(self.partner.customer_state, 'approved')
        self.partner.with_user(self.customer_approval_user).write({
            'phone': '555-666-777'
        })
