...
class Partner(models.Model):
    ...
    def name_search(self, name="", args=None, operator="ilike", limit=100):
        res = super()._name_search(name, args, operator, limit)
        ...
        if limit is None or len(res) < limit:
            ...
            partners = self._full_text_search(name, domain=args, limit=remaining_limit)
    ...
    def _full_text_search(self, name, domain=None, limit=None):
        full_text_domain = self._expand_full_text_domain([("full_text", "like", name)])
